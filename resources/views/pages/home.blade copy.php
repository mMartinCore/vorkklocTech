<x-layouts.guest_two :active="'home'">
    ...
    <x-hero-section 
        ...
        ctaButtonUrl="https://portal.watopak.com/register"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 relative z-10">
                ...
                <div class="maritime-card group relative p-8 pt-16 bg-white dark:bg-neutral-800/90 shadow-xl shadow-primary-500/10 dark:shadow-neutral-900/50 dark:backdrop-blur-lg border border-neutral-200 dark:border-neutral-700/50 flex flex-col items-center text-center performance-optimized loading-fade-in" data-aos="fade-up" data-aos-delay="50" role="article" aria-labelledby="step-1-title">
                    <div class="parallax-element step-number w-32 h-32 rounded-full border-2 border-primary-500 text-white flex items-center justify-center text-4xl mb-8 group-hover:scale-110 transition-all duration-500 relative -mt-28 shadow-xl shadow-primary-500/30 dark:shadow-neutral-900/50 bg-gradient-to-br from-primary-500 to-secondary-500" data-speed="-0.05">
                        ...
                        <svg class="relative z-10 w-12 h-12 text-white drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2C13.1 2 14 2.9 14 4V8C14 9.1 13.1 10 12 10S10 9.1 10 8V4C10 2.9 10.9 2 12 2M21 9V7L19 8L21 9M3 9L5 8L3 7V9M12 11C13.66 11 15 12.34 15 14V16L13.5 17.5C13.1 17.9 12.6 18 12 18S10.9 17.9 10.5 17.5L9 16V14C9 12.34 10.34 11 12 11Z"/>
                        </svg>
                ...
                <div class="maritime-card group relative p-8 pt-16 bg-white dark:bg-neutral-800/90 shadow-xl shadow-primary-500/10 dark:shadow-neutral-900/50 dark:backdrop-blur-lg border border-neutral-200 dark:border-neutral-700/50 flex flex-col items-center text-center performance-optimized loading-fade-in" data-aos="fade-up" data-aos-delay="100" role="article" aria-labelledby="step-2-title">
                    <div class="parallax-element step-number w-32 h-32 rounded-full border-2 border-primary-500 text-white flex items-center justify-center text-4xl mb-8 group-hover:scale-110 transition-all duration-500 relative -mt-28 shadow-xl shadow-primary-500/30 dark:shadow-neutral-900/50 bg-gradient-to-br from-primary-500 to-secondary-500" data-speed="-0.1">
                        ...
                        <!-- Professional SVG Icon -->
                        <svg class="relative z-10 w-12 h-12 text-white drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M17,18C17.5,18 18,17.5 18,17V5C18,4.5 17.5,4 17,4H7C6.5,4 6,4.5 6,5V17C6,17.5 6.5,18 7,18H17M10,7V9H14V7H10M10,11V13H14V11H10M10,15V17H14V15H10Z"/>
                        </svg>
                ...
                <div class="maritime-card group relative p-8 pt-16 bg-white dark:bg-neutral-800/90 shadow-xl shadow-primary-500/10 dark:shadow-neutral-900/50 dark:backdrop-blur-lg border border-neutral-200 dark:border-neutral-700/50 flex flex-col items-center text-center performance-optimized loading-fade-in" data-aos="fade-up" data-aos-delay="150" role="article" aria-labelledby="step-3-title">
                    <div class="parallax-element step-number w-32 h-32 rounded-full border-2 border-primary-500 text-white flex items-center justify-center text-4xl mb-8 group-hover:scale-110 transition-all duration-500 relative -mt-28 shadow-xl shadow-primary-500/30 dark:shadow-neutral-900/50 bg-gradient-to-br from-primary-500 to-secondary-500" data-speed="-0.15">
                        ...
                        <!-- Professional SVG Icon -->
                        <svg class="relative z-10 w-12 h-12 text-white drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M3,16.74L7.76,21.5C8.15,21.89 8.78,21.89 9.17,21.5L12,18.67L14.83,21.5C15.22,21.89 15.85,21.89 16.24,21.5L21,16.74V5C21,3.89 20.11,3 19,3H5A2,2 0 0,0 3,5V16.74M5,5H19V15.5L16.24,18.26L12,14L7.76,18.26L5,15.5V5Z"/>
                        </svg>
                    ...
                    <h3 id="step-3-title" class="step-title text-3xl font-bold text-neutral-900 dark:text-white mb-5 group-hover:text-primary-600 transition-colors duration-300 font-primary">Receive</h3>
                    
                    <p class="text-lg text-neutral-700 dark:text-neutral-200 font-secondary mb-8 leading-relaxed">
                        Fast, secure delivery to your doorstep in Jamaica via our professional shipping network.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="text-center mb-20" data-aos="fade-up">
                <div class="flex items-center justify-center mb-6">
                    <span class="px-6 py-2.5 bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 text-xs tracking-widest uppercase font-medium rounded-full border border-blue-200 dark:border-blue-800 shadow-lg backdrop-blur-md animate-fade-in">
                        <span class="font-display">Professional Services</span>
                    </span>
                </div>
                ...
                <p class="max-w-3xl mx-auto text-lg text-neutral-700 dark:text-neutral-300 leading-relaxed font-secondary">Watopak Logistics offers comprehensive shipping solutions to make your online shopping experience seamless and stress-free.</p>
            </div>
            <x-service-item-left 
                    tagColor="blue"
                    ...
                    title="USA Mailbox Service"
                    description="Get your personal USA shipping address to shop from American retailers online. Our reliable mail forwarding service allows you to consolidate packages and save on international shipping costs."
                    :features="[
                ...
                <x-service-item-right 
                    ...
                    :features="[
                        ...
                        'Premium tracking and insurance options',
                ...
                <x-service-item-left 
                    tagColor="purple"
                    tagText="Cost Effective"
                    iconPath="M3,13H1V11H3V13M5,11H22L19,8H8L5,11M7.5,15A1.5,1.5 0 0,0 6,16.5A1.5,1.5 0 0,0 7.5,18A1.5,1.5 0 0,0 9,16.5A1.5,1.5 0 0,0 7.5,15M16.5,15A1.5,1.5 0 0,0 15,16.5A1.5,1.5 0 0,0 16.5,18A1.5,1.5 0 0,0 18,16.5A1.5,1.5 0 0,0 16.5,15Z"
                    title="Secure Sea Freight"
                    description="Cost-effective containerized shipping for larger shipments with comprehensive security and insurance coverage. Perfect for bulk orders and non-urgent deliveries."
                    :features="[
                        '4-6 weeks delivery time',
                        'Economical for large shipments',
                        'Perfect for large items and bulk orders'
                    ]"
                    buttonText="Get Sea Freight Quote"
                    buttonUrl="https://portal.watopak.com/register"
                    imageUrl="{{ asset('images/wata-pak-large-cargo-ship-with-containers-port.jpg') }}"
                    imageAlt="Secure Sea Freight Service"
                    bgColor="purple"
                />
                ...
                <x-service-customs-clearance 
                    tag-color="primary"
                    tag-text="Customs Clearance"
                    ...
                    button-url="https://portal.watopak.com/register"
                    image-url="{{ asset('images/wato-pak-cargo-plane-sunset.jpg') }}"
                    image-alt="Customs Clearance Service"
                    bg-color="primary"
                />

                <x-service-premium-delivery
                    tag-color="primary"
                    tag-text="Eco-Friendly"
                    title="Green Delivery"
                    description="Environmentally conscious delivery service..."
                    :features="[
                    ...
                    button-url="https://portal.watopak.com/register"
                    image-url="{{ asset('images/wato-pak-cargo-plane-sunset.jpg') }}"
                    image-alt="Green Delivery Service"
                    bg-color="graprimaryy"
                />
    ...
    <section class="py-24 relative overflow-hidden bg-gray-50 dark:bg-gradient-to-b dark:from-neutral-800 dark:to-neutral-900">
        <!-- Background Elements -->
        <div class="absolute inset-0">
    ...
    <section class="relative py-20 md:py-48 bg-fixed bg-center bg-cover overflow-hidden" style="background-image: url('{{ asset('images/wato-global-shipping-international-logistics-illustration.jpg') }}');">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6" data-aos="fade-up" data-aos-delay="100">Ready to Ship with Premium Service?</h2>
                <p class="text-lg text-white/80 mb-10" data-aos="fade-up" data-aos-delay="200">Join thousands of satisfied customers who trust Watopak Logistics for their premium USA to Jamaica shipping needs.</p>
                <div class="flex flex-wrap justify-center gap-4" data-aos="fade-up" data-aos-delay="300">
                   
                      <a href="https://portal.watopak.com/register" class="hero-primary-btn group relative overflow-hidden bg-theme_color_secondary-100 text-white py-3 sm:py-4 px-6 sm:px-8 rounded-md shadow-2xl hover:shadow-theme_color_secondary-100/50 transition-all duration-500 uppercase tracking-wide text-sm inline-flex items-center justify-center">
